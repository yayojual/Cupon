...
class __TwigTemplate_9edcbf048786ed392fe83176d6651d2ae62634f030335ecb2e323469231d4ddb extends Twig_Template
{
    ...
    {
        echo "Tienda ";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tienda"]) ? $context["tienda"] : $this->getContext($context, "tienda")), "nombre", array()), "html", null, true);
    }
...
\t\t<p>";
        // line 9
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tienda"]) ? $context["tienda"] : $this->getContext($context, "tienda")), "descripcion", array()), "html", null, true);
        echo "</p>
\t</section>
\t
\t<section id=\"ultimas\">
...
\t\t<h2>Otras tiendas en ";
        // line 43
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["tienda"]) ? $context["tienda"] : $this->getContext($context, "tienda")), "ciudad", array()), "nombre", array()), "html", null, true);
        echo "</h2>
\t\t<ul>
\t\t\t";
        // line 45
