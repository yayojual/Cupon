...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cupon.tiendabundle.security.ownervoter'] = new \Cupon\TiendaBundle\Security\OwnerVoter();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'cupon', 'user' => 'cupon', 'password' => 'cupon', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_baeab11a08adcb7c6bf3c7262abc9f3d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_baeab11a08adcb7c6bf3c7262abc9f3d');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_baeab11a08adcb7c6bf3c7262abc9f3d');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Cupon/OfertaBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Cupon/CiudadBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Cupon/TiendaBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Cupon/UsuarioBundle/Entity')));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '636ed3036a87c609bdff108922b8a726c');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Cupon\\UsuarioBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Cupon\\TiendaBundle\\Entity\\Tienda' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_FrontendService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('login_path' => 'usuario_login', 'use_referer' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'));
        $j->setProviderKey('frontend');

        $k = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'frontend', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array('login_path' => 'usuario_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $c), array('check_path' => 'usuario_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $c, $d);
        $k->setRememberMeServices($h);

        return $this->services['security.firewall.map.context.frontend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.tiendas')), 'frontend', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '55250aab160ad', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'frontend', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'usuario_login', false), NULL, NULL, $c));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('juanmavacasanchez@gmail.com');
        $a->setPassword('juvasa291284');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin('jm8vak@hotmail.com', array());
    }
    ...
    {
        return $this->services['twig.extension.dump'] = new \Twig_Extensions_Extension_Debug();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Cupon/BackendBundle/Resources/views'), 'Backend');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('636ed3036a87c609bdff108922b8a726c');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'es',
            'secret' => '636ed3036a87c609bdff108922b8a726c',
            'cupon.ciudad_por_defecto' => 'barcelona',
            'cupon.directorio.imagenes' => ($this->targetDirs[2].'/../web/uploads/images/'),
            ...
            'kernel.secret' => '636ed3036a87c609bdff108922b8a726c',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'juanmavacasanchez@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'juvasa291284',
            ...
            'swiftmailer.mailer.default.single_address' => 'jm8vak@hotmail.com',
            'swiftmailer.mailer.default.delivery_whitelist' => array(

            ),
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'jm8vak@hotmail.com',
