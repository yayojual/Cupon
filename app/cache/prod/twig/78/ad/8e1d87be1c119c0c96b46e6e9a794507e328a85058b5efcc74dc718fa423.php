...
\t";
        // line 12
        $context["ciudadSeleccionada"] = $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "attributes", array()), "get", array(0 => "ciudad", 1 => (isset($context["ciudad_por_defecto"]) ? $context["ciudad_por_defecto"] : null)), "method");
        // line 13
        echo "
\t<header>
\t\t<h1><a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_portada", array("ciudad" => (isset($context["ciudadSeleccionada"]) ? $context["ciudadSeleccionada"] : null))), "html", null, true);
        echo "\">CUPON</a></h1>
\t\t<nav>
\t\t<ul>
\t\t\t<li><a href=\"";
...
\t\t\t<li><a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ciudad_recientes", array("ciudad" => (isset($context["ciudadSeleccionada"]) ? $context["ciudadSeleccionada"] : null))), "html", null, true);
...
(isset($context["ciudadSeleccionada"]) ? $context["ciudadSeleccionada"] : null))));
        // line 23
        echo "</li>
\t\t</ul>
\t\t</nav>
