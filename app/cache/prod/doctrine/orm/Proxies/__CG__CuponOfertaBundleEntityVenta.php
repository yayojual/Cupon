 ...
 */
class Venta extends \Cupon\OfertaBundle\Entity\Venta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setOferta(\Cupon\OfertaBundle\Entity\Oferta $oferta)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOferta', array($oferta));
